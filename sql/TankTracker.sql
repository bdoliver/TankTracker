...
INSERT INTO tracker_user VALUES ( 0, 'Guest', null, 'guest@example.com', 'guest', false );
INSERT INTO tracker_user VALUES ( default, 'Brendon', 'Oliver', 'brendon.oliver@gmail.com', 'testpw', true );
...
INSERT INTO tank VALUES ( 
	...
	'1000l Reef',
	( SELECT user_id FROM tracker_user WHERE email_address = 'brendon.oliver@gmail.com' )
);
INSERT INTO tank VALUES ( 
	default,
	( SELECT water_id FROM water_type WHERE water_type = 'Salt Water' ),
...
-- INSERT INTO tank_user VALUES ( 
-- 	( SELECT tank_id FROM tank WHERE tank_name = '1000l Reef' ),
-- 	( SELECT user_id FROM tracker_user WHERE email_address = 'brendon.oliver@gmail.com' ),
-- 	true );
-- INSERT INTO tank_user VALUES ( 
-- 	( SELECT tank_id FROM tank WHERE tank_name = 'RedSea Max 130' ),
-- 	( SELECT user_id FROM tracker_user WHERE email_address = 'brendon.oliver@gmail.com' ),
-- 	true );
-- INSERT INTO tank_user VALUES ( 
-- 	( SELECT tank_id FROM tank WHERE tank_name = 'Tropical' ),
-- 	( SELECT user_id FROM tracker_user WHERE email_address = 'brendon.oliver@gmail.com' ),
-- 	true );
